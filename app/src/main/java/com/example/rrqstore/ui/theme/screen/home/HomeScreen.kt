...
import com.example.rrqstore.ui.theme.components.SearchBar
...
import com.example.rrqstore.ui.theme.components.MerchItem
...
fun HomeContent(
    ...
    LazyVerticalGrid(
        ...
        items(merchOrder, key = {it.merch.id}) { data ->
            MerchItem(
                image = data.merch.image,
                title = data.merch.title,
                requiredPoint = data.merch.requiredMoney,
